...
module.exports = {
    data: new SlashCommandBuilder().setName("compressor")
    ...
    async execute(interaction) {
        ...
        if (!queue || !queue.isPlaying()) {
            ...
            const isEnabled = queue.filters.ffmpeg.filters.includes("compressor");
            const statusKey = isEnabled ? "commands.effects.compressor.enabled" : "commands.effects.compressor.disabled";
